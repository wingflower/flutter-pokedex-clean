...
void diSetup() {
  ...
  getIt.registerSingleton<GetUserAccountUseCase>(GetUserAccountUseCase(
      userAccountRepository: getIt<UserAccountRepository<String, String>>()));
  getIt.registerSingleton<RemoveUserAccountUseCase>(RemoveUserAccountUseCase(
      userAccountRepository: getIt<UserAccountRepository<String, String>>()));
  getIt.registerSingleton<RegisterUseCase>(
      RegisterUseCase(authRepository: getIt<AuthRepository<EmailPassword>>()));
  getIt.registerSingleton<RequestVerifyUseCase>(RequestVerifyUseCase(
      authRepository: getIt<AuthRepository<EmailPassword>>()));
  getIt.registerSingleton<LoginUseCase>(
      LoginUseCase(authRepository: getIt<AuthRepository<EmailPassword>>()));
  getIt.registerSingleton<CheckVerifyUseCase>(CheckVerifyUseCase(
      authRepository: getIt<AuthRepository<EmailPassword>>()));
  getIt.registerSingleton<ResetPasswordUseCase>(ResetPasswordUseCase(
      authRepository: getIt<AuthRepository<EmailPassword>>()));
  getIt.registerSingleton<StoreUserAccountUseCase>(StoreUserAccountUseCase(
      userAccountRepository: getIt<UserAccountRepository<String, String>>()));
  getIt.registerSingleton<LogoutUseCase>(
      LogoutUseCase(authRepository: getIt<AuthRepository<EmailPassword>>()));

  getIt.registerSingleton<GetPokemonUseCase>(
      GetPokemonUseCase(pokemonRepository: getIt<PokemonRepository>()));
