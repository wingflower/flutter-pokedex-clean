...
void diSetup() {
  ...
  getIt.registerFactory<LoginViewModel>(() => LoginViewModel(loginUseCase: getIt<LoginUseCase>(), registerUseCase: getIt<RegisterUseCase>()));
  getIt.registerFactory<VerifyViewModel>(() => VerifyViewModel(verifyUseCase: getIt<RequestVerifyUseCase>(), checkVerifyUseCase: getIt<CheckVerifyUseCase>()));
}
